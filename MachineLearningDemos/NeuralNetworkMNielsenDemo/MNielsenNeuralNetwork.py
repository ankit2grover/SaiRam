...
class Network:
    def __init__(self, sizes):
        ...
        self.weights = [np.random.randn(indexY, indexX) 
                        for indexY, indexX in zip(sizes[:-1], sizes[1:])]
    ...
    def feedForward(self, a):
        ...
        for bias, weight in (self.biases, self.weights):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data= None):
        ...
        for no_iteration in xrange(epochs):
            ...
            for mini_batch in mini_batches:
                ...
                print "bias value is " + self.biases
                print "bias value is " + self.weights
